...
- [x] Phase B-5: Recovery + error handling
- [x] Phase F-1: Design system + layout + stores
- [x] Phase F-2: Dashboard + canvas + semantic zoom
- [x] Phase F-3: Side panel + tabs
- [x] Phase F-4: Terminal + session lifecycle
- [x] Phase F-5: Decisions + business logic UI
- [x] Phase F-6: Command palette + shortcuts + polish
- [x] Phase INT: Integration testing

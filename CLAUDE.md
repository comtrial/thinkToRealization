...
- [ ] Phase B-1: Data layer migration
- [ ] Phase B-2: Session core (PTY + EventBus + StateMachine)
- [ ] Phase B-3: Realtime layer (WebSocket)
- [ ] Phase B-4: File watcher + decisions
- [ ] Phase B-5: Recovery + error handling
- [ ] Phase F-1: Design system + layout + stores
- [ ] Phase F-2: Dashboard + canvas + semantic zoom

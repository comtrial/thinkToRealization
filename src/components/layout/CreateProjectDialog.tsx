  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content data-testid="create-project-dialog" className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] bg-surface border border-border rounded-dropdown shadow-elevation-3 p-6 z-50 focus:outline-none">
